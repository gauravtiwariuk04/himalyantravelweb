...
const Usercardinfo = () => {
  ...
  const handleBookNow = (packageData) => {
    // This can be replaced with any action you want when Book Now is clicked
    console.log("Booking package:", packageData.title);
    // Example: window.location.href = `/book-now?package=${packageData.id}`;
    alert(`Booking ${packageData.title} - Redirect to booking page would happen here`);
  };
